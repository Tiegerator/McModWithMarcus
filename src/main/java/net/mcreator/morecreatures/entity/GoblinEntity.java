...
public class GoblinEntity extends TiegeratorsCreaturesModElements.ModElement {
	public static EntityType entity = null;
	public GoblinEntity(TiegeratorsCreaturesModElements instance) {
		super(instance, 4);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10053376, -6724096, new Item.Properties().group(MoreCreaturesItemGroup.tab))
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (!biomeCriteria)
				continue;
			biome.getSpawns(EntityClassification.CREATURE).add(new Biome.SpawnListEntry(entity, 50, 2, 10));
		}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelgoblin(), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("tiegerators_creatures:textures/goblin_tex.png");
				}
			};
		});
	}
