...
import net.mcreator.morecreatures.item.BoneClubItem;
...
public class GoblinFighterEntity extends TiegeratorsCreaturesModElements.ModElement {
	public static EntityType entity = null;
	public GoblinFighterEntity(TiegeratorsCreaturesModElements instance) {
		super(instance, 6);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("goblin_fighter")
						.setRegistryName("goblin_fighter");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -13395712, -3355444, new Item.Properties().group(MoreCreaturesItemGroup.tab))
				.setRegistryName("goblin_fighter_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (!biomeCriteria)
				continue;
			biome.getSpawns(EntityClassification.CREATURE).add(new Biome.SpawnListEntry(entity, 35, 1, 5));
		}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelgoblin_fighter(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("tiegerators_creatures:textures/goblin_fighter_tex.png");
				}
			};
		});
	}
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 3;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(BoneClubItem.block, (int) (1)));
		}
